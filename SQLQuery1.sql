...
Cpf						char(11)		not null references Matricula (cpf),
CodDisciplina			int				not null references Matricula (codDisciplina),
AnoSemestre			int				not null references Matricula (anoSemestre),
presenca				int				not null,
ausencia				int				not null
primary key(dataChamada, Cpf, CodDisciplina, AnoSemestre)
)
go
...
statusDispensa			varchar(10)				not null,				
